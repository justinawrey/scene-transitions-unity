...
namespace SceneTransitions
{
    ...
    public class SceneTransitionSetting
    {
        ...
        public SceneTransition Transition =>
            PossibleTransitions[Random.Range(0, PossibleTransitions.Count)];
    }

    [CreateAssetMenu(
        fileName = "Scene Transition Settings",
        menuName = "Scene Transitions/Scene Transition Settings"
    )]
    public class SceneTransitionSettings : ScriptableObject
    {
        [SerializeField]
        private List<SceneTransition> _enterFirstSceneTransitions;
